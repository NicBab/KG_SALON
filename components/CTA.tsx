...
const CTA = () => {
  return (
    <section
      className={`${styles.flexCenter} h-[300px] m-5 p-10 flex-col rounded-[20px] z-[2] border border-green-50 bg bg-yellow-50 shadow opacity-90`}
    >
      
      <div className="flex-1 flex flex-col z-[1]">
        
        <h2 className={`${styles.cardHeading} mt-5`}>Walk ins welcome!</h2>
