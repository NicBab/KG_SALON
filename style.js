const styles = {
    ...
    paragraph: "p-8 font-poppins font-normal text-green-90 text-[14px] md:text-[16px] leading-[35px] indent-5",

    cardHeading: "font-poppins flex justify-center font-semibold text-[20px] text-black leading-[40px] w-full",
